...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullUp() {
		float exactContentHeight = FloatMath.floor(this.mRefreshableView.getContentHeight() * this.mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
			...
			OverscrollHelper.overScrollBy(PullToRefreshWebView.this, deltaY, scrollY, this.getScrollRange(), OVERSCROLL_FUZZY_THRESHOLD, OVERSCROLL_SCALE_FACTOR, isTouchEvent);

			return returnValue;
		}

		private int getScrollRange() {
			return (int) Math.max(0, FloatMath.floor(PullToRefreshWebView.this.mRefreshableView.getContentHeight() * PullToRefreshWebView.this.mRefreshableView.getScale()) - (this.getHeight() - this.getPaddingBottom() - this.getPaddingTop()));
		}
	}
}
